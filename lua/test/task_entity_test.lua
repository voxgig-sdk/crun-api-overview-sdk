...
describe("TaskEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CRUNAPIOVERVIEW_TEST_TASK_ENTID JSON to run live")
      return
    end
...
function task_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CRUNAPIOVERVIEW_TEST_TASK_ENTID")
