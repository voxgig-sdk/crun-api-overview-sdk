...
|---|---|---|
| `ts/` | @voxgig-sdk/crun-api-overview-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/crun-api-overview-sdk \
      --repository voxgig-sdk/crun-api-overview-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/crun-api-overview-sdk` shows it, and
`npm trust revoke @voxgig-sdk/crun-api-overview-sdk --id=<id>` removes it.
