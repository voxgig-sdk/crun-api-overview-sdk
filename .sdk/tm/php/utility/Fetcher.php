...
// CrunApiOverview SDK utility: fetcher

class CrunApiOverviewFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CrunApiOverviewSDK/1.0)';
    ...
    public static function call(CrunApiOverviewContext $ctx, string $fullurl, array $fetchdef): array
    {
