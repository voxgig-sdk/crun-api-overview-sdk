...
// CrunApiOverview SDK pipeline test
//
...
{
    private static function utility(): CrunApiOverviewUtility
    {
        return new CrunApiOverviewUtility();
    }
    ...
    private static function ctx(array $over = []): CrunApiOverviewContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CrunApiOverviewContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CrunApiOverviewOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CrunApiOverviewError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CrunApiOverviewOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CrunApiOverviewMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CrunApiOverviewOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CrunApiOverviewMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CrunApiOverviewOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CrunApiOverviewMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CrunApiOverviewSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CrunApiOverviewMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CrunApiOverviewResponse([]),
            'result' => new CrunApiOverviewResult([]),
        ]);
        [, $err] = CrunApiOverviewMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CrunApiOverviewSpec([]),
            'response' => null,
            'result' => new CrunApiOverviewResult([]),
        ]);
        [, $err] = CrunApiOverviewMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CrunApiOverviewSpec(['step' => 's']),
            'response' => new CrunApiOverviewResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CrunApiOverviewResult([]),
        ]);
        [, $err] = CrunApiOverviewMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CrunApiOverviewSpec(['step' => 's']),
            'response' => new CrunApiOverviewResponse(self::resp(200, ['v' => 1])),
            'result' => new CrunApiOverviewResult([]),
        ]);
        [, $err] = CrunApiOverviewMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CrunApiOverviewSpec(['step' => 's']),
            'response' => new CrunApiOverviewResponse(self::resp(200, ['v' => 2])),
            'result' => new CrunApiOverviewResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CrunApiOverviewMakeResponse::call($ctx);
    ...
    {
        $preset = new CrunApiOverviewResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CrunApiOverviewSpec([]),
            'response' => new CrunApiOverviewResponse([]),
            'result' => new CrunApiOverviewResult([]),
        ...
        [$got, $err] = CrunApiOverviewMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CrunApiOverviewResult([])]);
        [, $err] = CrunApiOverviewMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CrunApiOverviewSpec([]), 'result' => null]);
        [, $err] = CrunApiOverviewMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CrunApiOverviewSpec(['step' => 's']),
            'result' => new CrunApiOverviewResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CrunApiOverviewOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CrunApiOverviewMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CrunApiOverviewSpec(['step' => 's']),
            'result' => new CrunApiOverviewResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CrunApiOverviewOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CrunApiOverviewMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CrunApiOverviewResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CrunApiOverviewSpec([]),
            'result' => new CrunApiOverviewResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CrunApiOverviewMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CrunApiOverviewMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CrunApiOverviewError('boom', 'boom');
        $utility->fetcher = function (CrunApiOverviewContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CrunApiOverviewSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CrunApiOverviewMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CrunApiOverviewContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CrunApiOverviewMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CrunApiOverviewResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CrunApiOverviewMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CrunApiOverviewContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CrunApiOverviewSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CrunApiOverviewMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CrunApiOverviewResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CrunApiOverviewSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CrunApiOverviewMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CrunApiOverviewMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CrunApiOverviewMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CrunApiOverviewResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CrunApiOverviewDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CrunApiOverviewResult(['ok' => false])]);
        $this->expectException(CrunApiOverviewError::class);
        CrunApiOverviewDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CrunApiOverviewResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CrunApiOverviewMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CrunApiOverviewMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CrunApiOverviewBaseFeature();
        $b = new CrunApiOverviewBaseFeature();
        CrunApiOverviewFeatureAdd::call($ctx, $a);
        CrunApiOverviewFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CrunApiOverviewBaseFeature
    {
        $f = new CrunApiOverviewBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CrunApiOverviewFeatureAdd::call($ctx, self::named_feature('a'));
        CrunApiOverviewFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        CrunApiOverviewFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        CrunApiOverviewFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        CrunApiOverviewFeatureAdd::call($ctx, $replace);
        ...
        CrunApiOverviewFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CrunApiOverviewContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CrunApiOverviewSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CrunApiOverviewPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CrunApiOverviewPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CrunApiOverviewResponse(['headers' => null]),
            'result' => new CrunApiOverviewResult([]),
        ]);
        CrunApiOverviewResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CrunApiOverviewResultBody::call($ctx);
