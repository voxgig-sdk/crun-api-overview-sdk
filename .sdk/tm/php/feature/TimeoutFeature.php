...
// CrunApiOverview SDK timeout feature
...
class CrunApiOverviewTimeoutFeature extends CrunApiOverviewBaseFeature
{
    ...
    private function _with_timeout(CrunApiOverviewContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CrunApiOverviewContext $_ctx, float $ms): void
    {
        $client = $this->client;
