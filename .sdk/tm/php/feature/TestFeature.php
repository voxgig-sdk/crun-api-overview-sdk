...
// CrunApiOverview SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CrunApiOverviewTestFeature extends CrunApiOverviewBaseFeature
{
    ...
    public function init(CrunApiOverviewContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CrunApiOverviewContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CrunApiOverviewParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CrunApiOverviewContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CrunApiOverviewContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = CrunApiOverviewParam::call($ctx, $k);
