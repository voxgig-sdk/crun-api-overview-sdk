...
// CrunApiOverview SDK ratelimit feature
...
class CrunApiOverviewRatelimitFeature extends CrunApiOverviewBaseFeature
{
    ...
    private function _acquire(CrunApiOverviewContext $ctx): void
    {
    ...
    private function _track(CrunApiOverviewContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
