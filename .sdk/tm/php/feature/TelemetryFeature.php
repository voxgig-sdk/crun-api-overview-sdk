...
// CrunApiOverview SDK telemetry feature
...
class CrunApiOverviewTelemetryFeature extends CrunApiOverviewBaseFeature
{
    ...
    private function _close(CrunApiOverviewContext $ctx, bool $ok): void
    {
