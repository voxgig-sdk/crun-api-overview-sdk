...
// CrunApiOverview SDK proxy feature
...
class CrunApiOverviewProxyFeature extends CrunApiOverviewBaseFeature
{
    ...
    public function init(CrunApiOverviewContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CrunApiOverviewContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
