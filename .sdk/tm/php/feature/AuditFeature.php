...
// CrunApiOverview SDK audit feature
...
class CrunApiOverviewAuditFeature extends CrunApiOverviewBaseFeature
{
    ...
    private function _emit(CrunApiOverviewContext $ctx, string $outcome): void
    {
