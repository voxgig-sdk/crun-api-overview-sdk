...
// CrunApiOverview SDK idempotency feature
...
class CrunApiOverviewIdempotencyFeature extends CrunApiOverviewBaseFeature
{
    ...
    private function _mutating(CrunApiOverviewContext $ctx): bool
    {
