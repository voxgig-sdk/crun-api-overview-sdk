...
// CrunApiOverview SDK rbac feature
...
class CrunApiOverviewRbacFeature extends CrunApiOverviewBaseFeature
{
    ...
    private function _required(CrunApiOverviewContext $ctx): ?string
    {
    ...
    private function _reject(CrunApiOverviewContext $ctx, string $required): void
    {
    ...
    private function _track(CrunApiOverviewContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
