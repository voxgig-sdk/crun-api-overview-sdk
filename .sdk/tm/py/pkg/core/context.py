...
from projectname_sdk.core.control import CrunApiOverviewControl
...
class CrunApiOverviewContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CrunApiOverviewControl()
        ...
        if isinstance(sp, CrunApiOverviewSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CrunApiOverviewResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CrunApiOverviewResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CrunApiOverviewOperation({})
    ...
    def make_error(self, code, msg):
        return CrunApiOverviewError(code, msg, self)
