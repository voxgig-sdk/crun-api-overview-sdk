...
class CrunApiOverviewTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CrunApiOverviewTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CrunApiOverviewTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CrunApiOverviewTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
