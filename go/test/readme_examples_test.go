...
const testSeed = `map[string]any{"entity": map[string]any{"generate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "task": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
