...
type CrunApiOverviewSDK struct {
	Mode     string
...
func (sdk *CrunApiOverviewSDK) OptionsMap() map[string]any {
...
func (sdk *CrunApiOverviewSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CrunApiOverviewSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CrunApiOverviewSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CrunApiOverviewSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CrunApiOverviewSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CrunApiOverviewSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CrunApiOverviewSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CrunApiOverviewSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CrunApiOverviewSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CrunApiOverviewSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *CrunApiOverviewSDK {
	...
	sdk := NewCrunApiOverviewSDK(sdkopts)
	sdk.Mode = "test"
