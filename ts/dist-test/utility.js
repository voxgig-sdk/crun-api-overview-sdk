...
function envOverride(m) {
    if ('TRUE' === process.env.CRUN_API_OVERVIEW_TEST_LIVE ||
        'TRUE' === process.env.CRUN_API_OVERVIEW_TEST_OVERRIDE) {
    ...
    m.CRUN_API_OVERVIEW_TEST_EXPLAIN = process.env.CRUN_API_OVERVIEW_TEST_EXPLAIN || m.CRUN_API_OVERVIEW_TEST_EXPLAIN;
    return m;
}
