...
(0, node_test_1.describe)('TaskDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CrunApiOverviewSDK({
...
function liveScenariosActive() { return false && process.env.CRUN_API_OVERVIEW_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CrunApiOverviewSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.CRUN_API_OVERVIEW_APIKEY,
        }));
        let idmap = env['CRUN_API_OVERVIEW_TEST_TASK_ENTID'];
    ...
    const client = new __1.CrunApiOverviewSDK({
        base: 'http://localhost:8080',
