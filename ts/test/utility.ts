...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.CRUNAPIOVERVIEW_TEST_LIVE ||
    'TRUE' === process.env.CRUNAPIOVERVIEW_TEST_OVERRIDE
  ) {
  ...
  m.CRUNAPIOVERVIEW_TEST_EXPLAIN = process.env.CRUNAPIOVERVIEW_TEST_EXPLAIN || m.CRUNAPIOVERVIEW_TEST_EXPLAIN
