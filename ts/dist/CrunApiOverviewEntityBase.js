...
exports.CrunApiOverviewEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends CrunApiOverviewEntityBase<Advice>`.
class CrunApiOverviewEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.CrunApiOverviewEntityBase = CrunApiOverviewEntityBase;
//# sourceMappingURL=CrunApiOverviewEntityBase.js.map