# CrunApiOverview SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CrunApiOverviewSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CrunApiOverviewSDK(...) and CrunApiOverviewSDK.test(...) become
#      CrunApiOverviewSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "crunapioverview_sdk"
_SDK_CLASS = "CrunApiOverviewSDK"
