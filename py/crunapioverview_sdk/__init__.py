...
from crunapioverview_sdk.utility import register

# Load features
from crunapioverview_sdk.feature.base_feature import CrunApiOverviewBaseFeature
from crunapioverview_sdk.features import _has_feature, _make_feature
...
class CrunApiOverviewSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CrunApiOverviewUtility()
        self._utility = utility

        from crunapioverview_sdk.config import shared_config
    ...
    def get_utility(self):
        return CrunApiOverviewUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CrunApiOverviewSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Generate(self, data=None) -> "GenerateEntity":
        ...
        from crunapioverview_sdk.entity.generate_entity import GenerateEntity
        return GenerateEntity(self, data)


    def Task(self, data=None) -> "TaskEntity":
        """Entity factory: client.Task().list() / client.Task().load({"id": ...})."""
        from crunapioverview_sdk.entity.task_entity import TaskEntity
