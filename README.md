...
```bash
cd go-mcp && go build -o crun-api-overview-mcp .
```
...
```json
{
  "mcpServers": {
    "crun-api-overview": {
      "command": "/abs/path/to/crun-api-overview-mcp"
    }
  }
}
```
...
Generated from the Crun API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
