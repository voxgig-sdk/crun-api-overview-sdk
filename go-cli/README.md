...
AQL-driven CLI and REPL for the CrunApiOverview SDK. Positional arguments are
...
```sh
go build -o crun-api-overview-cli ./...
```
...
./crun-api-overview-cli list generate
./crun-api-overview-cli load 1 generate
./crun-api-overview-cli load '{id:1}' generate
