...
func registerSDKWords(r *eng.Registry, client *sdk.CrunApiOverviewSDK) {
...
func runOp(client *sdk.CrunApiOverviewSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
