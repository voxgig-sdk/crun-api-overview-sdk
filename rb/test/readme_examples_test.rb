...
#      offline in seeded test mode (CrunApiOverviewSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CrunApiOverview_sdk.rb")
  SDK_CLASS = "CrunApiOverviewSDK"
