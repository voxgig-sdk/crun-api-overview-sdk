...
class TaskEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CRUN_API_OVERVIEW_TEST_TASK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def task_basic_setup(extra)
  ...
  entid_env_raw = ENV["CRUN_API_OVERVIEW_TEST_TASK_ENTID"]
