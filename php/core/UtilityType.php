...
// CrunApiOverview SDK utility type

class CrunApiOverviewUtility
{
    ...
    public static function copy(CrunApiOverviewUtility $src): CrunApiOverviewUtility
    {
        $u = new CrunApiOverviewUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
