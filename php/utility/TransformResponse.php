...
// CrunApiOverview SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CrunApiOverviewTransformResponse
{
    public static function call(CrunApiOverviewContext $ctx): mixed
    {
        ...
        $transform = CrunApiOverviewHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
