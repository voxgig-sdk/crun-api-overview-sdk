...
// CrunApiOverview SDK utility: graphql
//
...
class CrunApiOverviewGraphql
{
    ...
    // equivalent.
    public static function body(CrunApiOverviewContext $ctx): mixed
    {
    ...
    public static function errors(CrunApiOverviewContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
