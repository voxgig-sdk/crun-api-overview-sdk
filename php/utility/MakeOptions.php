...
// CrunApiOverview SDK utility: make_options

class CrunApiOverviewMakeOptions
{
    ...
    public static function call(CrunApiOverviewContext $ctx): array
    {
        ...
        //
        // `CrunApiOverviewSchema::optspec()` is built from the model:
        ...
        $optspec = CrunApiOverviewSchema::optspec();
