...
// CrunApiOverview SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CrunApiOverviewSDK::test)
...
{
    private const SDK_CLASS = 'CrunApiOverviewSDK';
    ...
    private const SDK_BASE = 'crunapioverview_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../crunapioverview_sdk.php';
