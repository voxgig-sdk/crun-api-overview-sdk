...
// CrunApiOverview SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CrunApiOverviewOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CrunApiOverviewOmni::structfix($now, Struct::undef()))
                        !== json_encode(CrunApiOverviewOmni::structfix($val, Struct::undef()))) {
