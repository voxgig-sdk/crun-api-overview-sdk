...
// CrunApiOverview SDK debug feature
...
class CrunApiOverviewDebugFeature extends CrunApiOverviewBaseFeature
{
    ...
    private function _finish(CrunApiOverviewContext $ctx, bool $ok): void
    {
