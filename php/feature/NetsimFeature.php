...
// CrunApiOverview SDK netsim feature
...
class CrunApiOverviewNetsimFeature extends CrunApiOverviewBaseFeature
{
    ...
    private function _simulate(CrunApiOverviewContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CrunApiOverviewContext $ctx, array $applied): void
    {
        $client = $this->client;
