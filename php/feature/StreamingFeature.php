...
// CrunApiOverview SDK streaming feature
...
class CrunApiOverviewStreamingFeature extends CrunApiOverviewBaseFeature
{
    ...
    private function _iterate(CrunApiOverviewResult $result): \Generator
    {
    ...
    private function _streamable(CrunApiOverviewContext $ctx): bool
    {
