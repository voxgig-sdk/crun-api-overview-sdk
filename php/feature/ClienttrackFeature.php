...
// CrunApiOverview SDK clienttrack feature
...
class CrunApiOverviewClienttrackFeature extends CrunApiOverviewBaseFeature
{
    ...
    public function PostConstruct(CrunApiOverviewContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CrunApiOverview-SDK';
