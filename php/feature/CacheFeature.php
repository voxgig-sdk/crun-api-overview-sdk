...
// CrunApiOverview SDK cache feature
...
class CrunApiOverviewCacheFeature extends CrunApiOverviewBaseFeature
{
    ...
    private function _through(CrunApiOverviewContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
