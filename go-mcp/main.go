// Command CrunApiOverview-mcp is an MCP server exposing the CrunApiOverview
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CrunApiOverview_list  — list records of an entity
//	CrunApiOverview_load  — load a single record of an entity
//
