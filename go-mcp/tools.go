...
type Args struct {
	Entity string         `json:"entity" jsonschema:"generate | task"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CrunApiOverviewSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "crun-api-overview_list",
		Description: "List records from CrunApiOverview. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "crun-api-overview_load",
		Description: "Load a single record from CrunApiOverview. " +
...
func runOp(client *sdk.CrunApiOverviewSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CrunApiOverviewSDK, name string) (sdk.CrunApiOverviewEntity, error) {
